    ...
    <div className="space-y-4 pt-6 max-w-2xl">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center pt-2">
        <button
          ...
          className="btn-cta text-lg font-bold whitespace-nowrap"
        >
          Get Quote →
        </button>
        ...
        <div className="flex items-center gap-2">
          ...
          <a href={`tel:${phone}`} className="text-gray-700 hover:text-gray-900 transition-colors font-medium">
            Call Us Today
          </a>
        </div>
      </div>
      ...
      {/* Trust Disclaimer */}
      <div className="pt-4 text-xs text-gray-600 border-t border-gray-300 italic">
